...
class Config:
    BASE_MODELS = {
        ...
        'bertin_base': Path("Model/1. Base/bert-base-multilingual-cased"),
    ...
    if tipo == '1':
        ...
        for num in numeros:
            if 1 <= num <= 5:
                ...
                TRAINED_MODEL_ENSABMLE.append(Config.TRAINED_MODELS[name_model[num-1]])
                list_model.append("")
            else:
...
def clasificar_polaridad():
    ...
    # Aquí iría la lógica de clasificación
